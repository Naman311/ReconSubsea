...
class Ui_widget_3(QWidget):
    ...
    def setupUi(self, widget_3):
        ...
        self.label_5.setPixmap(QtGui.QPixmap("logo_final.png"))
        self.pushButton = QtWidgets.QPushButton(widget_3)
        self.pushButton.setGeometry(QtCore.QRect(480, 520, 171, 23))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(widget_3)
        self.pushButton_2.setGeometry(QtCore.QRect(40, 520, 161, 23))
    ...
    def retranslateUi(self, widget_3):
        ...
        self.pushButton.setText(_translate("widget_3", "Switch On Camera Feed"))
        self.pushButton_2.setText(_translate("widget_3", "Switch On Orientation Feed"))
