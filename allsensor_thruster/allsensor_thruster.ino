...
void move_down()
{
  int signal=map(nos[1],1,10,1501,1700);
...
void move_up()
{
  int signal=map(nos[1],-10,0,1300,1500);
  l.writeMicroseconds(signal);
  r.writeMicroseconds(signal);
}
void move_forward()
{
  int signal=map(nos[3],-10,0,1300,1500);
  fl.writeMicroseconds(signal);
  fr.writeMicroseconds(signal);
}
void move_backward()
{
  int signal=map(nos[3],1,10,1501,1700);
  fl.writeMicroseconds(signal);
  fr.writeMicroseconds(signal);
}
void move_left()
{
  int signal=map(nos[2],-10,0,1300,1500);
  fl.writeMicroseconds(signal);
  bl.writeMicroseconds(signal);
}
void move_right()
{
  int signal=map(nos[2],1,10,1501,1700);
  fr.writeMicroseconds(signal);
  br.writeMicroseconds(signal);
}
void roll_right()
{
  int signal1=map(nos[0],1,10,1501,1700);
  int signal2=map(nos[0],1,10,1499,1300);
  l.writeMicroseconds(signal1);
  r.writeMicroseconds(signal2);
}
void roll_left()
{
  int signal1=map(nos[0],-10,0,1700,1501);
  int signal2=map(nos[0],-10,0,1499,1300);
  l.writeMicroseconds(signal2);
  r.writeMicroseconds(signal1);
}
/*void pitch_anti()
{//yet to complete
  int signal=map(nos[0],-10,0,1300,1500);
}
void pitch_cloc()
{//yet to complete
...
///////////////////////////////////////////////////////////////////////////////////////////
  ...
  l.writeMicroseconds(1500); // send "stop" signal to ESC.
  r.writeMicroseconds(1500); // send "stop" signal to ESC.
  fl.writeMicroseconds(1500); // send "stop" signal to ESC.
  fr.writeMicroseconds(1500); // send "stop" signal to ESC.
  bl.writeMicroseconds(1500); // send "stop" signal to ESC.
  br.writeMicroseconds(1500); // send "stop" signal to ESC.
